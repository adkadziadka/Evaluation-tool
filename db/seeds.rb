...
# student2 = Student.create!( {picture: "https://goo.gl/r5cw83", full_name: "John Doe", batch: batch1} )
# student3 = Student.create!( {picture: "https://goo.gl/r5cw83", full_name: "John Doe", batch: batch1} )
# student4 = Student.create!( {picture: "https://goo.gl/r5cw83", full_name: "John Doe", batch: batch2} )
# student5 = Student.create!( {picture: "https://goo.gl/r5cw83", full_name: "John Doe", batch: batch2} )
# student6 = Student.create!( {picture: "https://goo.gl/r5cw83", full_name: "John Doe", batch: batch3} )
# student7 = Student.create!( {picture: "https://goo.gl/r5cw83", full_name: "John Doe", batch: batch3} )
# student8 = Student.create!( {picture: "https://goo.gl/r5cw83", full_name: "John Doe", batch: batch3} )
# student9 = Student.create!( {picture: "https://goo.gl/r5cw83", full_name: "John Doe", batch: batch4} )
# student10 = Student.create!( {picture: "https://goo.gl/r5cw83", full_name: "John Doe", batch: batch4} )
